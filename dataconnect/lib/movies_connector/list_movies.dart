...
class ListMoviesVariablesBuilder {
  Optional<OrderDirection> _orderByRating =
      Optional.optional(orderDirectionDeserializer, enumSerializer);
  Optional<OrderDirection> _orderByReleaseYear =
      Optional.optional(orderDirectionDeserializer, enumSerializer);
  ...
  Serializer<ListMoviesVariables> varsSerializer =
      (ListMoviesVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<ListMoviesData, ListMoviesVariables>> execute() {
    return this.ref().execute();
  }

  QueryRef<ListMoviesData, ListMoviesVariables> ref() {
    ListMoviesVariables vars = ListMoviesVariables(
      orderByRating: _orderByRating,
      orderByReleaseYear: _orderByReleaseYear,
      limit: _limit,
    );

    return _dataConnect.query(
        "ListMovies", dataDeserializer, varsSerializer, vars);
  }
}
...
class ListMoviesVariables {
  ...
  ListMoviesVariables.fromJson(Map<String, dynamic> json) {
    orderByRating =
        Optional.optional(orderDirectionDeserializer, enumSerializer);
    orderByRating.value = json['orderByRating'] == null
        ? null
        : OrderDirection.values.byName(json['orderByRating']);

    orderByReleaseYear =
        Optional.optional(orderDirectionDeserializer, enumSerializer);
    orderByReleaseYear.value = json['orderByReleaseYear'] == null
        ? null
        : OrderDirection.values.byName(json['orderByReleaseYear']);

    limit = Optional.optional(nativeFromJson, nativeToJson);
    limit.value =
        json['limit'] == null ? null : nativeFromJson<int>(json['limit']);
  }
