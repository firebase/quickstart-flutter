...
class GetActorByIdVariablesBuilder {
  ...
  GetActorByIdVariablesBuilder(
    this._dataConnect, {
    required String this.id,
  });
  Deserializer<GetActorByIdData> dataDeserializer =
      (dynamic json) => GetActorByIdData.fromJson(jsonDecode(json));
  Serializer<GetActorByIdVariables> varsSerializer =
      (GetActorByIdVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetActorByIdData, GetActorByIdVariables>> execute() {
    return this.ref().execute();
  }

  QueryRef<GetActorByIdData, GetActorByIdVariables> ref() {
    GetActorByIdVariables vars = GetActorByIdVariables(
      id: id,
    );

    return _dataConnect.query(
        "GetActorById", dataDeserializer, varsSerializer, vars);
  }
}
...
class GetActorByIdActor {
  ...
  GetActorByIdActor.fromJson(dynamic json)
      : id = nativeFromJson<String>(json['id']),
        ...
        mainActors = (json['mainActors'] as List<dynamic>)
            .map((e) => GetActorByIdActorMainActors.fromJson(e))
            .toList(),
        supportingActors = (json['supportingActors'] as List<dynamic>)
