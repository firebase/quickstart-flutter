...
class GetActorByIdVariablesBuilder {
  ...
  GetActorByIdVariablesBuilder(this._dataConnect, {required  this.id,});
...
class GetActorByIdActor {
  ...
  id = nativeFromJson<String>(json['id']),name = nativeFromJson<String>(json['name']),imageUrl = nativeFromJson<String>(json['imageUrl']),mainActors = (json['mainActors'] as List<dynamic>)
...
class GetActorByIdActorMainActors {
  ...
  id = nativeFromJson<String>(json['id']),title = nativeFromJson<String>(json['title']),genre = json['genre'] == null ? null : nativeFromJson<String>(json['genre']),tags = json['tags'] == null ? null : (json['tags'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),imageUrl = nativeFromJson<String>(json['imageUrl']);
...
class GetActorByIdData {
  ...
  actor = json['actor'] == null ? null : GetActorByIdActor.fromJson(json['actor']);
