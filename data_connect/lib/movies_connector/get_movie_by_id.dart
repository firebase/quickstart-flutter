...
class GetMovieByIdMovie {
  ...
  id = nativeFromJson<String>(json['id']),title = nativeFromJson<String>(json['title']),imageUrl = nativeFromJson<String>(json['imageUrl']),releaseYear = json['releaseYear'] == null ? null : nativeFromJson<int>(json['releaseYear']),genre = json['genre'] == null ? null : nativeFromJson<String>(json['genre']),rating = json['rating'] == null ? null : nativeFromJson<double>(json['rating']),description = json['description'] == null ? null : nativeFromJson<String>(json['description']),tags = json['tags'] == null ? null : (json['tags'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),metadata = (json['metadata'] as List<dynamic>)
        .map((e) => GetMovieByIdMovieMetadata.fromJson(e))
        .toList(),mainActors = (json['mainActors'] as List<dynamic>)
        .map((e) => GetMovieByIdMovieMainActors.fromJson(e))
        .toList(),supportingActors = (json['supportingActors'] as List<dynamic>)
        .map((e) => GetMovieByIdMovieSupportingActors.fromJson(e))
        .toList(),reviews = (json['reviews'] as List<dynamic>)
  ...
  Map<String, dynamic> toJson() {
    ...
    json['mainActors'] = mainActors.map((e) => e.toJson()).toList();
    json['supportingActors'] = supportingActors.map((e) => e.toJson()).toList();
...
class GetMovieByIdMovieMetadata {
  ...
  director = json['director'] == null ? null : nativeFromJson<String>(json['director']);

  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
    if (director != null) {
      json['director'] = nativeToJson<String?>(director);
    }
    return json;
  }
...
class GetMovieByIdMovieReviews {
  ...
  id = nativeFromJson<String>(json['id']),reviewText = json['reviewText'] == null ? null : nativeFromJson<String>(json['reviewText']),reviewDate = nativeFromJson<DateTime>(json['reviewDate']),rating = json['rating'] == null ? null : nativeFromJson<int>(json['rating']),user = GetMovieByIdMovieReviewsUser.fromJson(json['user']);
