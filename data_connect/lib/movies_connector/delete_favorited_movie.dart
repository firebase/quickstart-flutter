...
class DeleteFavoritedMovieVariablesBuilder {
  ...
  DeleteFavoritedMovieVariablesBuilder(
    this._dataConnect, {
    required String this.movieId,
  });
  Deserializer<DeleteFavoritedMovieData> dataDeserializer =
      (dynamic json) => DeleteFavoritedMovieData.fromJson(jsonDecode(json));
  Serializer<DeleteFavoritedMovieVariables> varsSerializer =
      (DeleteFavoritedMovieVariables vars) => jsonEncode(vars.toJson());
  Future<
      OperationResult<DeleteFavoritedMovieData,
          DeleteFavoritedMovieVariables>> execute() {
    return this.ref().execute();
  }

  MutationRef<DeleteFavoritedMovieData, DeleteFavoritedMovieVariables> ref() {
    DeleteFavoritedMovieVariables vars = DeleteFavoritedMovieVariables(
      movieId: movieId,
    );

    return _dataConnect.mutation(
        "DeleteFavoritedMovie", dataDeserializer, varsSerializer, vars);
  }
}
...
class DeleteFavoritedMovieData {
  ...
  DeleteFavoritedMovieData.fromJson(dynamic json)
      : favorite_movie_delete = json['favorite_movie_delete'] == null
            ? null
            : DeleteFavoritedMovieFavoriteMovieDelete.fromJson(
  ...
  Map<String, dynamic> toJson() {
    ...
    if (favorite_movie_delete != null) {
      json['favorite_movie_delete'] = favorite_movie_delete!.toJson();
    }
