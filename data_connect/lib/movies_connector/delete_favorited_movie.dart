...
class DeleteFavoritedMovieVariablesBuilder {
  ...
  DeleteFavoritedMovieVariablesBuilder(this._dataConnect, {required  this.movieId,});
...
class DeleteFavoritedMovieData {
  ...
  favorite_movie_delete = json['favorite_movie_delete'] == null ? null : DeleteFavoritedMovieFavoriteMovieDelete.fromJson(json['favorite_movie_delete']);
