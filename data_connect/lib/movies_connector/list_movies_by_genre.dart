...
class ListMoviesByGenreVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  ListMoviesByGenreVariablesBuilder orderByRating(OrderDirection? t) {
  ...
  ListMoviesByGenreVariablesBuilder(this._dataConnect, {required  this.genre,});
...
class ListMoviesByGenreVariables {
  ...
  genre = nativeFromJson<String>(json['genre']) {
    ...
    orderByRating.value = json['orderByRating'] == null ? null : OrderDirection.values.byName(json['orderByRating']);
  
    orderByReleaseYear = Optional.optional(orderDirectionDeserializer, enumSerializer);
    orderByReleaseYear.value = json['orderByReleaseYear'] == null ? null : OrderDirection.values.byName(json['orderByReleaseYear']);
