...
class GetCurrentUserVariablesBuilder {
  ...
  GetCurrentUserVariablesBuilder(
    this._dataConnect,
  );
  Deserializer<GetCurrentUserData> dataDeserializer =
      (dynamic json) => GetCurrentUserData.fromJson(jsonDecode(json));
  ...
  QueryRef<GetCurrentUserData, void> ref() {
    return _dataConnect.query(
        "GetCurrentUser", dataDeserializer, emptySerializer, null);
  }
}
...
class GetCurrentUserUserReviews {
  ...
  GetCurrentUserUserReviews.fromJson(dynamic json)
      : id = nativeFromJson<String>(json['id']),
        ...
        movie = GetCurrentUserUserReviewsMovie.fromJson(json['movie']) {}
  ...
  GetCurrentUserUserFavoriteMoviesMovie.fromJson(dynamic json)
      : id = nativeFromJson<String>(json['id']),
        ...
        metadata = (json['metadata'] as List<dynamic>)
            .map((e) =>
                GetCurrentUserUserFavoriteMoviesMovieMetadata.fromJson(e))
            .toList() {}
