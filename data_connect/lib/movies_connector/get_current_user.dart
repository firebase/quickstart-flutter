...
class GetCurrentUserUser {
  ...
  id = nativeFromJson<String>(json['id']),username = nativeFromJson<String>(json['username']),reviews = (json['reviews'] as List<dynamic>)
        .map((e) => GetCurrentUserUserReviews.fromJson(e))
        .toList(),favoriteMovies = (json['favoriteMovies'] as List<dynamic>)
...
class GetCurrentUserUserReviews {
  ...
  id = nativeFromJson<String>(json['id']),rating = json['rating'] == null ? null : nativeFromJson<int>(json['rating']),reviewDate = nativeFromJson<DateTime>(json['reviewDate']),reviewText = json['reviewText'] == null ? null : nativeFromJson<String>(json['reviewText']),movie = GetCurrentUserUserReviewsMovie.fromJson(json['movie']);
...
class GetCurrentUserUserFavoriteMovies {
  ...
  movie = GetCurrentUserUserFavoriteMoviesMovie.fromJson(json['movie']);
...
class GetCurrentUserUserFavoriteMoviesMovie {
  ...
  id = nativeFromJson<String>(json['id']),title = nativeFromJson<String>(json['title']),genre = json['genre'] == null ? null : nativeFromJson<String>(json['genre']),imageUrl = nativeFromJson<String>(json['imageUrl']),releaseYear = json['releaseYear'] == null ? null : nativeFromJson<int>(json['releaseYear']),rating = json['rating'] == null ? null : nativeFromJson<double>(json['rating']),description = json['description'] == null ? null : nativeFromJson<String>(json['description']),tags = json['tags'] == null ? null : (json['tags'] as List<dynamic>)
