...
class SearchAllVariablesBuilder {
  ...
  SearchAllVariablesBuilder(
    this._dataConnect, {
    required int this.minYear,
    required int this.maxYear,
    required double this.minRating,
    required double this.maxRating,
    required String this.genre,
  });
  Deserializer<SearchAllData> dataDeserializer =
      (dynamic json) => SearchAllData.fromJson(jsonDecode(json));
  Serializer<SearchAllVariables> varsSerializer =
      (SearchAllVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<SearchAllData, SearchAllVariables>> execute() {
    return this.ref().execute();
  }

  QueryRef<SearchAllData, SearchAllVariables> ref() {
    SearchAllVariables vars = SearchAllVariables(
      input: _input,
      minYear: minYear,
      maxYear: maxYear,
      minRating: minRating,
    ...
    return _dataConnect.query(
        "SearchAll", dataDeserializer, varsSerializer, vars);
  }
}
...
class SearchAllReviewsMatchingText {
  ...
  SearchAllReviewsMatchingText.fromJson(dynamic json)
      : id = nativeFromJson<String>(json['id']),
        ...
        movie = SearchAllReviewsMatchingTextMovie.fromJson(json['movie']),
        user = SearchAllReviewsMatchingTextUser.fromJson(json['user']) {}
      ...
      : moviesMatchingTitle = (json['moviesMatchingTitle'] as List<dynamic>)
        ...
        moviesMatchingDescription =
            (json['moviesMatchingDescription'] as List<dynamic>)
                ...
                .toList(),
        actorsMatchingName = (json['actorsMatchingName'] as List<dynamic>)
            .map((e) => SearchAllActorsMatchingName.fromJson(e))
            .toList(),
        reviewsMatchingText = (json['reviewsMatchingText'] as List<dynamic>)
...
class SearchAllVariables {
  ...
  SearchAllVariables.fromJson(Map<String, dynamic> json)
      : minYear = nativeFromJson<int>(json['minYear']),
        maxYear = nativeFromJson<int>(json['maxYear']),
        minRating = nativeFromJson<double>(json['minRating']),
        maxRating = nativeFromJson<double>(json['maxRating']),
        genre = nativeFromJson<String>(json['genre']) {
    input = Optional.optional(nativeFromJson, nativeToJson);
    input.value =
        json['input'] == null ? null : nativeFromJson<String>(json['input']);
  }
