...
class SearchAllVariablesBuilder {
  ...
  SearchAllVariablesBuilder(this._dataConnect, {required  this.minYear,required  this.maxYear,required  this.minRating,required  this.maxRating,required  this.genre,});
...
class SearchAllMoviesMatchingTitle {
  ...
  id = nativeFromJson<String>(json['id']),title = nativeFromJson<String>(json['title']),genre = json['genre'] == null ? null : nativeFromJson<String>(json['genre']),rating = json['rating'] == null ? null : nativeFromJson<double>(json['rating']),imageUrl = nativeFromJson<String>(json['imageUrl']);
...
class SearchAllActorsMatchingName {
  ...
  id = nativeFromJson<String>(json['id']),name = nativeFromJson<String>(json['name']),imageUrl = nativeFromJson<String>(json['imageUrl']);
...
class SearchAllReviewsMatchingText {
  ...
  id = nativeFromJson<String>(json['id']),rating = json['rating'] == null ? null : nativeFromJson<int>(json['rating']),reviewText = json['reviewText'] == null ? null : nativeFromJson<String>(json['reviewText']),reviewDate = nativeFromJson<DateTime>(json['reviewDate']),movie = SearchAllReviewsMatchingTextMovie.fromJson(json['movie']),user = SearchAllReviewsMatchingTextUser.fromJson(json['user']);
...
class SearchAllReviewsMatchingTextMovie {
  ...
  id = nativeFromJson<String>(json['id']),title = nativeFromJson<String>(json['title']);
...
class SearchAllReviewsMatchingTextUser {
  ...
  id = nativeFromJson<String>(json['id']),username = nativeFromJson<String>(json['username']);
...
class SearchAllData {
  ...
  moviesMatchingTitle = (json['moviesMatchingTitle'] as List<dynamic>)
        .map((e) => SearchAllMoviesMatchingTitle.fromJson(e))
        .toList(),moviesMatchingDescription = (json['moviesMatchingDescription'] as List<dynamic>)
        .map((e) => SearchAllMoviesMatchingDescription.fromJson(e))
        .toList(),actorsMatchingName = (json['actorsMatchingName'] as List<dynamic>)
        .map((e) => SearchAllActorsMatchingName.fromJson(e))
        .toList(),reviewsMatchingText = (json['reviewsMatchingText'] as List<dynamic>)
        .map((e) => SearchAllReviewsMatchingText.fromJson(e))
        .toList();

  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
    json['moviesMatchingTitle'] = moviesMatchingTitle.map((e) => e.toJson()).toList();
    json['moviesMatchingDescription'] = moviesMatchingDescription.map((e) => e.toJson()).toList();
    json['actorsMatchingName'] = actorsMatchingName.map((e) => e.toJson()).toList();
    json['reviewsMatchingText'] = reviewsMatchingText.map((e) => e.toJson()).toList();
    return json;
  }
...
class SearchAllVariables {
  ...
  minYear = nativeFromJson<int>(json['minYear']),maxYear = nativeFromJson<int>(json['maxYear']),minRating = nativeFromJson<double>(json['minRating']),maxRating = nativeFromJson<double>(json['maxRating']),genre = nativeFromJson<String>(json['genre']) {
  
    input = Optional.optional(nativeFromJson, nativeToJson);
    input.value = json['input'] == null ? null : nativeFromJson<String>(json['input']);
  ...
  Map<String, dynamic> toJson() {
    ...
    json['minYear'] = nativeToJson<int>(minYear);
    json['maxYear'] = nativeToJson<int>(maxYear);
    json['minRating'] = nativeToJson<double>(minRating);
    json['maxRating'] = nativeToJson<double>(maxRating);
    json['genre'] = nativeToJson<String>(genre);
    return json;
  }
