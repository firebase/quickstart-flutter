...
class UpdateReviewVariablesBuilder {
  ...
  UpdateReviewVariablesBuilder(
    this._dataConnect, {
    required String this.movieId,
    required int this.rating,
    required String this.reviewText,
  });
  Deserializer<UpdateReviewData> dataDeserializer =
      (dynamic json) => UpdateReviewData.fromJson(jsonDecode(json));
  Serializer<UpdateReviewVariables> varsSerializer =
      (UpdateReviewVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpdateReviewData, UpdateReviewVariables> ref() {
    UpdateReviewVariables vars = UpdateReviewVariables(
      movieId: movieId,
      rating: rating,
    ...
    return _dataConnect.mutation(
        "UpdateReview", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpdateReviewData {
  ...
  UpdateReviewData.fromJson(dynamic json)
      : review_update = json['review_update'] == null
            ? null
